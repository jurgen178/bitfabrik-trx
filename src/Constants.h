...
#define LANG_DE // Standard auf Deutsch für Tests
  ...
  #define L_SIGNAL_GEN    "SIGNALGENERATOR"
  #define L_BACK          "ZURUECK"
  #define L_PA_DISABLED   "Endstufe inaktiv"
  ...
  #define L_SIGNAL_GEN    "SIGNAL GENERATOR"
  #define L_BACK          "BACK"
  #define L_PA_DISABLED   "PA disabled"
  #define L_TAB_VOX       "VOX"
